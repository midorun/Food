...
function calculator() {
  var calculatingResult = document.querySelector('.calculating__result span');
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, alt, title, description, price, parentSelector) {
      ...
      value: function render() {
        ...
        if (this.classes.length) {
          this.classes.forEach(function (item) {
            return card.classList.add(item);
          });
        } else {
...
function forms(formsSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    ...
    function showThanksModal(message) {
      var offerSliderPrevModalDialog = document.querySelector('.modal__dialog');
      offerSliderPrevModalDialog.classList.add('hide');
      (0,_modal__WEBPACK_IMPORTED_MODULE_8__.openModal)('.modal', modalTimerId);
      var thanksModalDiv = document.createElement('div');
...
function slider(_ref) {
  ...
  var index = 1,
      offset = 0;
  total.textContent = (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getZero)(offerSlides.length);
  offerSlider.style.position = 'relative';
  offerSliderInner.style.width = "".concat(100 * offerSlides.length, "%");
  ...
  offerSlides.forEach(function (item, i) {
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      ...
      if (e.target && e.target.classList.contains('dot')) {
        ...
        current.textContent = (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getZero)(index);
  ...
  function changeInnerOffset() {
    offerSliderInner.style.transform = "translateX(-".concat(offset, "px)");
  }
